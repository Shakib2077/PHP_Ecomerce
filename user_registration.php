        ...
        <div class="col-lg-12 col-xl-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-4 pt-2">
                    ...
                    <p class="small fw-bold mt-4 pt-1 mb-0">Already have an account ?<a href="user_login.php" class="text-danger"> Login</a></p>
                </div>
...
if(isset($_POST['user_register'])){
   ...
   if($rows_count>0){
    ...
    echo "<script>window.open('checkput.php'.'_self')</script>";
   }else{
